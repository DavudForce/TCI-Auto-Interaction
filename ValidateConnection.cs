...
namespace adsl_Auto_Interaction_App
{
    ...
    {
        /***************************** CLIENT ***************************/
        static string configFile =  Path.Combine(Application.StartupPath + @"\server\server.beshonic.h");
        static string passwordFile = Path.Combine(Application.StartupPath + @"\server\server.beshonic.k");
